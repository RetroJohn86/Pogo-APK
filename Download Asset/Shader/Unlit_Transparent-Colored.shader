...
void main()
{
    ...
    u_xlat2.xyz = u_xlat10_1.xyz * _Color.xyz + (-unity_FogColor.xyz);
    u_xlat1.w = u_xlat10_1.w * _Color.w;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_1.xyz * _Color.xyz + (-unity_FogColor.xyz);
    u_xlat1.w = u_xlat16_1.w * _Color.w;
    u_xlat1.xyz = vec3(u_xlat0) * u_xlat2.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat1;
    return;
}
