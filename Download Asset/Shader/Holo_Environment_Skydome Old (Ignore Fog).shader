...
//
///////////////////////////////////////////
Shader "Holo/Environment/Skydome Old (Ignore Fog)" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.xy = u_xlat0.xx + vec2(_HorizonHeight, _FogHeight);
...
void main()
{
    u_xlat10_0 = texture2D(_StarTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 * vec4(vs_TEXCOORD1);
    SV_Target0 = u_xlat0 * vec4(_StarStrength) + vs_COLOR0;
    return;
}
...
void main()
{
    u_xlat16_0 = texture(_StarTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat16_0 * vec4(vs_TEXCOORD1);
    SV_Target0 = u_xlat0 * vec4(_StarStrength) + vs_COLOR0;
    return;
}
