...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(u_xlat0) + u_xlat8.xyz;
    ...
    u_xlat10_1.xy = texture2D(_CrackTex, vs_TEXCOORD3.xy).xy;
...
UNITY_LOCATION(1) uniform mediump sampler2D _CrackTex;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_0.www * u_xlat16_3.xyz + u_xlat16_2.xyz;
    u_xlat16_3.xyz = (-vec3(_CrackAmount)) + vec3(1.04999995, 1.0, 1.04999995);
    u_xlat16_1.xy = texture(_CrackTex, vs_TEXCOORD3.xy).xy;
