...
//
///////////////////////////////////////////
Shader "Unlit/Texture-Alpha-Color" {
Properties {
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_0.xyz * glstate_lightmodel_ambient.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(4.0, 4.0, 4.0) + (-u_xlat16_0.xyz);
