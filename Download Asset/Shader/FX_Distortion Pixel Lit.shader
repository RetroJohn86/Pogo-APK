...
//
///////////////////////////////////////////
Shader "FX/Distortion Pixel Lit" {
Properties {
...
void main()
{
    ...
    u_xlat1.xy = (-u_xlat16_4.xy) * u_xlat1.xy + u_xlat16_0.xy;
    u_xlat10_0 = texture2D(_GrabTexture, u_xlat1.xy);
...
void main()
{
    ...
    u_xlat16_4.xy = vs_TEXCOORD3.xy / vs_TEXCOORD2.ww;
    u_xlat1.xy = (-u_xlat16_4.xy) * u_xlat1.xy + u_xlat16_0.xy;
    u_xlat16_0 = texture(_GrabTexture, u_xlat1.xy);
