...
void main()
{
    ...
    vs_COLOR0 = in_COLOR0 * vec4(_Intensity);
    u_xlat0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    vs_TEXCOORD0.z = u_xlat0.y * _Falloff;
...
void main()
{
    u_xlat0 = (-_Color) + _EdgeColor;
    u_xlat0 = vs_TEXCOORD0.zzzz * u_xlat0 + _Color;
