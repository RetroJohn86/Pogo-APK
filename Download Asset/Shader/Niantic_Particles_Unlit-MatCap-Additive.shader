...
//
///////////////////////////////////////////
Shader "Niantic/Particles/Unlit-MatCap-Additive" {
Properties {
_MainTex ("Base (RGB) Gloss (A)", 2D) = "white" { }
_TintColor ("Tint Color", Color) = (1,1,1,1)
_SelfIllumination ("_SelfIllumination", Range(0, 2)) = 1
...
#endif
precision highp int;
uniform 	mediump float _SelfIllumination;
...
void main()
{
    ...
    u_xlat16_1 = vs_COLOR0 * vec4(_SelfIllumination);
...
void main()
{
    ...
    u_xlat16_1 = vs_COLOR0 * vec4(_SelfIllumination);
    u_xlat0 = u_xlat10_0 * vs_COLOR0 + u_xlat16_1;
    u_xlat16_1.x = vs_TEXCOORD0.z * _Alpha;
