...
//
///////////////////////////////////////////
Shader "Holo/Sky/Cloudscape_DayNightTint" {
Properties {
_HighlightColor ("Highlight Color", Color) = (1,1,1,1)
_Color ("Main Color", Color) = (1,1,1,1)
_CloudShadowColor ("Shadow Color", Color) = (1,1,1,1)
_MainTex ("Main Texture", 2D) = "white" { }
_DaytimeAlpha ("Daytime Alpha", Range(0, 1)) = 1
_NighttimeAlpha ("Nighttime Alpha", Range(0, 1)) = 1
...
uniform 	mediump float _DaytimeAlpha;
uniform 	mediump float _NighttimeAlpha;
...
void main()
{
    ...
    u_xlat1 = _SunAngle / _TransitionAngle;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat7 = (-_NighttimeAlpha) + _DaytimeAlpha;
    u_xlat1 = u_xlat1 * u_xlat7 + _NighttimeAlpha;
    u_xlat1 = u_xlat1 * u_xlat10_1.y;
