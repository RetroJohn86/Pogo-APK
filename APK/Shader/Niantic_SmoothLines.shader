...
void main()
{
    u_xlat0 = float(1.0) / _Edge;
    u_xlat10_2.xy = texture2D(_MainTex, vs_TEXCOORD0.xy).xy;
    u_xlat1.xyz = u_xlat10_2.xyx * _TintColor.xyx;
    u_xlat0 = u_xlat0 * u_xlat1.z;
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat2 = u_xlat0 * -2.0 + 3.0;
    u_xlat0 = u_xlat0 * u_xlat0;
    u_xlat1.w = u_xlat0 * u_xlat2;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat16_2.xyx * _TintColor.xyx;
    u_xlat0 = u_xlat0 * u_xlat1.z;
