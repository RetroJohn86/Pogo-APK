...
_SpeedLevel ("Speed Level", Range(-1, 1)) = 0
_MoveDistance ("Move Distance", Vector) = (0,0,0,0)
_RotationSpeed ("Rotation Speed", Float) = 0
[Toggle(USE_SINE_ROTATION)] _UseSinFunction ("Use Sine On Rotation", Float) = 0
_RotationPivot ("Rotation Pivot", Vector) = (0,0,0,0)
...
uniform 	mediump vec4 _MoveDistance;
uniform 	float _SpeedLevel;
uniform 	float _RotationSpeed;
uniform 	mediump vec4 _RotationPivot;
...
void main()
{
    ...
    u_xlat4 = u_xlat0.x * _MoveDistance.y;
    u_xlat1.x = u_xlat0.x * _MoveDistance.x + in_POSITION0.x;
    u_xlat1.y = u_xlat4 * _SpeedLevel + in_POSITION0.y;
    ...
    u_xlat0.xy = u_xlat0.xy + (-_RotationPivot.xy);
    u_xlat8 = _Time.y * _RotationSpeed;
    u_xlat1.x = sin(u_xlat8);
    u_xlat2.x = cos(u_xlat8);
    u_xlat3.x = (-u_xlat1.x);
    u_xlat2.y = u_xlat1.x;
    u_xlat1.x = dot(u_xlat0.xy, u_xlat2.xy);
    u_xlat3.y = u_xlat2.x;
    u_xlat1.y = dot(u_xlat0.xy, u_xlat3.xy);
    vs_TEXCOORD0.xy = u_xlat1.xy + _RotationPivot.xy;
...
void main()
{
    ...
    u_xlat1.x = u_xlat0.x * _MoveDistance.x + in_POSITION0.x;
    u_xlat0.x = u_xlat0.x * _RotationSpeed;
    ...
    u_xlat0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat0.xy = u_xlat0.xy + (-_RotationPivot.xy);
    u_xlat1.y = dot(u_xlat0.xy, u_xlat1.xy);
