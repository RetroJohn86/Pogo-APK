...
Properties {
 _Alpha ("Alpha (output)", Range(0.000000,1.000000)) = 1.000000
 _Rotation ("Rotation", Range(0.000000,360.000000)) = 0.000000
[NoScaleOffset]  _Tex ("Cubemap   (HDR)", CUBE) = "grey" { }
[Toggle(BRB_LIGHTING_TWOSIDED)]  _Street ("    Is Street View?", Float) = 0.000000
 _Bluriness ("    Bluriness", Range(0.000000,1.000000)) = 0.000000
[Toggle(_BASEALPHA_UNLIT)]  _Unlit ("    Disable LightKit", Float) = 0.000000
[KeywordEnum(Off, Wrap_U, Horizon_Clamp, Horizon_Clip)]  _Mirror_V ("    Horizon Mode ('Wrap_U' means 'Horizon_Mirror')", Float) = 0.000000
 _HorizonOffset ("    Horizon Offset (combined)", Range(-0.500000,0.500000)) = 0.000000
 _CubeHorizon ("    Horizon Offset (cubemap only)", Range(-0.500000,0.500000)) = 0.000000
[KeywordEnum(Off, Composite, Horizon_Clamp, Horizon_Fake)]  _Fog ("Fog Mode", Float) = 0.000000
 _FogAlpha ("Fog Alpha (minimum)", Range(0.000000,1.000000)) = 1.000000
 _FogHorizonHeight ("Fog Horizon Height", Range(0.000000,10.000000)) = 0.100000
[Enum(UnityEngine.Rendering.CullMode)]  _Cull ("Culling Mode (Off = double-sided)", Float) = 0.000000
...
void main ()
{
  ...
  tmpvar_6 = ((_Tex_HDR.x * tmpvar_5.w) * tmpvar_5.xyz);
  highp vec3 tmpvar_7;
  tmpvar_7 = mix (tmpvar_6, xlv_TEXCOORD1.xyz, xlv_TEXCOORD0.www);
  c_2 = tmpvar_7;
