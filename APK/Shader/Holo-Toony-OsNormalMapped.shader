...
void main ()
{
  ...
  worldNormal_7 = tmpvar_31;
  highp float tmpvar_32;
  tmpvar_32 = clamp ((1.0 - (
    ((unity_ObjectToWorld * _glesVertex).y - _Ground)
   * unity_AmbientGround.w)), 0.0, 1.0);
  lowp float tmpvar_33;
  tmpvar_33 = max (0.0, -(worldNormal_7.y));
  highp vec4 tmpvar_34;
  tmpvar_34.xyz = (mix (unity_AmbientEquator.xyz, unity_AmbientGround.xyz, vec3((
    (tmpvar_32 * tmpvar_32)
   * tmpvar_33))) * tmpvar_6.x);
  tmpvar_34.w = (tmpvar_13 * tmpvar_14).w;
  highp vec4 tmpvar_35;
  tmpvar_35.w = 1.0;
  tmpvar_35.xyz = _glesVertex.xyz;
  ...
  gl_Position = (glstate_matrix_mvp * tmpvar_35);
...
void main ()
{
  ...
  tmpvar_34 = max (0.0, -(worldNormal_7.y));
  highp vec4 tmpvar_35;
  tmpvar_35.xyz = (mix (unity_AmbientEquator.xyz, unity_AmbientGround.xyz, vec3((
    (tmpvar_32 * tmpvar_32)
   * tmpvar_34))) * tmpvar_6.x);
  tmpvar_35.w = (tmpvar_13 * tmpvar_14).w;
  highp vec4 tmpvar_36;
  tmpvar_36.w = 1.0;
  tmpvar_36.xyz = _glesVertex.xyz;
  tmpvar_2.xy = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
  tmpvar_2.zw = ((_glesMultiTexCoord0.xy * _OsNormalMap_ST.xy) + _OsNormalMap_ST.zw);
  highp vec4 v_37;
  v_37.x = tmpvar_17;
  ...
  tmpvar_3 = worldNormal_1;
  gl_Position = (glstate_matrix_mvp * tmpvar_36);
  xlv_TEXCOORD0 = tmpvar_2;
  xlv_TEXCOORD1 = tmpvar_3;
  xlv_COLOR0 = tmpvar_5;
  xlv_TEXCOORD2 = tmpvar_6;
...
void main ()
{
  ...
  tmpvar_14 = max (0.0, -(worldNormal_3.y));
  highp vec4 tmpvar_15;
  tmpvar_15.xyz = (mix (unity_AmbientEquator.xyz, unity_AmbientGround.xyz, vec3((
    (tmpvar_13 * tmpvar_13)
   * tmpvar_14))) * tmpvar_2.x);
  tmpvar_15.w = (tmpvar_6 * tmpvar_7).w;
  highp vec3 vertex_16;
  vertex_16 = _glesVertex.xyz;
  ...
  if ((unity_LightShadowBias.z != 0.0)) {
    ...
    highp vec3 tmpvar_19;
    tmpvar_19 = (unity_ObjectToWorld * tmpvar_18).xyz;
    highp vec4 v_20;
    ...
    clipPos_17 = (glstate_matrix_mvp * tmpvar_26);
  };
...
void main ()
{
  ...
  tmpvar_16.w = (tmpvar_6 * tmpvar_7).w;
  highp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = _glesVertex.xyz;
  xlv_TEXCOORD0 = (tmpvar_14.xyz - _LightPositionRange.xyz);
