...
void main()
{
    ...
    u_xlat10_1.xy = texture2D(_MainTex, vs_TEXCOORD0.xy).xw;
    u_xlat0 = (-u_xlat10_1.y) + u_xlat10_0;
    u_xlat0 = _EnableExternalAlpha * u_xlat0 + u_xlat10_1.y;
...
void main()
{
    ...
    u_xlat16_1.xy = texture(_MainTex, vs_TEXCOORD0.xy).xw;
    u_xlat0 = (-u_xlat16_1.y) + u_xlat16_0;
    u_xlat0 = _EnableExternalAlpha * u_xlat0 + u_xlat16_1.y;
    u_xlat2 = (-vs_COLOR0.w) + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(u_xlat16_1.x>=u_xlat2);
#else
    u_xlatb1 = u_xlat16_1.x>=u_xlat2;
#endif
    u_xlat1 = u_xlatb1 ? 1.0 : float(0.0);
