...
void main ()
{
  ...
  if ((unity_LightShadowBias.z != 0.0)) {
    ...
    tmpvar_26 = normalize((tmpvar_3 * tmpvar_25));
    ...
    tmpvar_28.w = 1.0;
    tmpvar_28.xyz = (tmpvar_24 - (tmpvar_26 * (unity_LightShadowBias.z * 
      sqrt((1.0 - (tmpvar_27 * tmpvar_27)))
    )));
    clipPos_22 = (unity_MatrixVP * tmpvar_28);
  } else {
    highp vec4 tmpvar_29;
    tmpvar_29.w = 1.0;
    tmpvar_29.xyz = vertex_21;
    clipPos_22 = (glstate_matrix_mvp * tmpvar_29);
  };
  highp vec4 clipPos_30;
  clipPos_30.xyw = clipPos_22.xyw;
  clipPos_30.z = (clipPos_22.z + clamp ((unity_LightShadowBias.x / clipPos_22.w), 0.0, 1.0));
  clipPos_30.z = mix (clipPos_30.z, max (clipPos_30.z, -(clipPos_22.w)), unity_LightShadowBias.y);
