...
void main()
{
    ...
    vs_TEXCOORD1.xy = in_TEXCOORD1.xy * _AlphaTex_ST.xy + _AlphaTex_ST.zw;
...
void main()
{
    u_xlat10_0 = texture2D(_AlphaTex, vs_TEXCOORD1.xy).w;
...
void main()
{
    u_xlat16_0 = texture(_AlphaTex, vs_TEXCOORD1.xy).w;
