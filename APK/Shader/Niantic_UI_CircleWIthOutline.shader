...
//
///////////////////////////////////////////
Shader "Niantic/UI/CircleWIthOutline" {
Properties {
...
void main()
{
    ...
    u_xlat16_3 = dFdx(u_xlat16_0);
    u_xlat16_6 = dFdy(u_xlat16_0);
    u_xlat16_3 = abs(u_xlat16_6) + abs(u_xlat16_3);
    u_xlat16_6 = (-u_xlat16_0) + vs_TEXCOORD2.z;
    ...
    u_xlat10 = u_xlat10_1.w * _CenterColor.w;
    u_xlat16_2.xyz = u_xlat10_1.xyz * _CenterColor.xyz + (-vs_COLOR0.xyz);
    u_xlat16_2.w = u_xlat10 * vs_COLOR0.w + (-vs_COLOR0.w);
    u_xlat16_1 = vec4(u_xlat16_3) * u_xlat16_2 + vs_COLOR0;
...
void main()
{
    ...
    u_xlat10 = u_xlat16_1.w * _CenterColor.w;
    u_xlat16_2.xyz = u_xlat16_1.xyz * _CenterColor.xyz + (-vs_COLOR0.xyz);
    u_xlat16_2.w = u_xlat10 * vs_COLOR0.w + (-vs_COLOR0.w);
    u_xlat16_1 = vec4(u_xlat16_3) * u_xlat16_2 + vs_COLOR0;
    SV_Target0.w = u_xlat16_0 * u_xlat16_1.w;
    SV_Target0.xyz = u_xlat16_1.xyz;
