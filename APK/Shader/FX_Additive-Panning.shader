...
void main()
{
    u_xlat0.x = vs_TEXCOORD1.y * _Falloff;
    u_xlat1 = (-_Color) + _EdgeColor;
    u_xlat0 = u_xlat0.xxxx * u_xlat1 + _Color;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat10_1 * vec4(_Intensity);
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_1 * vec4(_Intensity);
    u_xlat0 = u_xlat0 * u_xlat16_1;
    SV_Target0 = u_xlat0 * vs_COLOR0;
    return;
}
