...
//
///////////////////////////////////////////
Shader "Holo/Character/Transparent/OS Normal Mapped" {
Properties {
...
void main ()
{
  ...
  xlv_TEXCOORD4 = (tmpvar_33 * abs(rim_8));
}
...
Fallback "Holo/Character/Transparent/Pixel Lit"
}