...
[Toggle(BRB_SCROLL)]  _Scroll ("    Only RG", Float) = 0.000000
 _DistortionAmount ("Distortion Amount", Range(-2.000000,2.000000)) = 0.000000
 _Speed ("Distortion Speed (Distort Map RG.uv, Distort Map BA.uv)", Vector) = (0.000000,0.000000,0.000000,0.000000)
