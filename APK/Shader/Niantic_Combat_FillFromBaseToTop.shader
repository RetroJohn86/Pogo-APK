...
uniform 	mediump vec4 _FillOffsetColor;
...
void main()
{
    ...
    u_xlatb9 = _TimerFillValue>=u_xlat9;
    u_xlat9 = u_xlatb9 ? 0.200000003 : float(0.0);
    u_xlat3 = dot(u_xlat0.yz, u_xlat0.yz);
    u_xlat0.x = (-u_xlat0.x) + _FillAmt;
    u_xlat0.x = u_xlat0.x * 50.0;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat3 = sqrt(u_xlat3);
    u_xlat6 = (-_UnfilledOuterFeather) + _UnfilledOuterThickness;
    ...
    u_xlat6 = _UnfillOuter + -1.0;
    u_xlat6 = u_xlat3 * u_xlat6 + 1.0;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2.xyz = u_xlat10_1.xyz * _UnfillColor.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat6) + _FillOffsetColor.xyz;
    u_xlat1.xyz = u_xlat10_1.xyz + (-u_xlat2.xyz);
    u_xlat6 = u_xlat10_1.w * vs_COLOR0.w;
    ...
    SV_Target0.w = min(u_xlat0.x, u_xlat6);
    return;
}
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_1.xyz * _UnfillColor.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat6) + _FillOffsetColor.xyz;
    u_xlat1.xyz = u_xlat16_1.xyz + (-u_xlat2.xyz);
    u_xlat6 = u_xlat16_1.w * vs_COLOR0.w;
    u_xlat10 = u_xlat0.x * -2.0 + 3.0;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat10;
    u_xlat1.xyz = u_xlat0.xxx * u_xlat1.xyz + u_xlat2.xyz;
