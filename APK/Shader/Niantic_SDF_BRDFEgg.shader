...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _SDFTex_ST.xy + _SDFTex_ST.zw;
    u_xlat10_0 = texture2D(_SDFTex, u_xlat0.xy);
    u_xlat0.x = dot(u_xlat10_0, _SDFChannels);
    u_xlat16_1.x = (-_OutlineDistance) + _ClippingValue;
    u_xlat16_1.x = u_xlat0.x + u_xlat16_1.x;
    u_xlat16_7 = u_xlat0.x + _ClippingValue;
    u_xlat16_1.y = log2(u_xlat16_7);
    u_xlat16_1.x = log2(u_xlat16_1.x);
    u_xlat16_13 = exp2(_EdgeFalloff);
    u_xlat16_1.xy = u_xlat16_1.xy * vec2(u_xlat16_13);
    u_xlat16_1.y = exp2(u_xlat16_1.y);
    u_xlat16_1.x = exp2(u_xlat16_1.x);
    u_xlat16_1.xy = min(u_xlat16_1.xy, vec2(1.0, 1.0));
    u_xlat16_2.xyz = (-_PrimaryColor.xyz) + _OutlineColor.xyz;
    u_xlat16_2.xyz = u_xlat16_1.yyy * u_xlat16_2.xyz + _PrimaryColor.xyz;
    u_xlat16_7 = u_xlat16_1.y + _Amount_RimLt;
    u_xlat16_3.xyz = (-u_xlat16_2.xyz) + _SecondaryColor.xyz;
    u_xlat16_1.xzw = u_xlat16_1.xxx * u_xlat16_3.xyz + u_xlat16_2.xyz;
    u_xlat16_1.xzw = u_xlat16_1.xzw + vs_TEXCOORD1.yyy;
    u_xlat16_1.xzw = clamp(u_xlat16_1.xzw, 0.0, 1.0);
    u_xlat16_1.xzw = u_xlat16_1.xzw + (-_ShadowColor.xyz);
    u_xlat16_1.xzw = vs_TEXCOORD1.xxx * u_xlat16_1.xzw + _ShadowColor.xyz;
    u_xlat0.x = _cKey.w + _cKey.w;
    u_xlat6.x = _cRimt.w + _cRimt.w;
    u_xlat10_2 = texture2D(_Ramp2D, vs_TEXCOORD2.xy);
    u_xlat16_3.xyz = u_xlat10_2.xxx * _cRimt.xyz;
    u_xlat6.xyz = u_xlat6.xxx * u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat10_2.zzz * _cKey.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat0.xxx + u_xlat6.xyz;
    ...
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(u_xlat16_7) + u_xlat16_4.xyz;
    SV_TARGET0.xyz = u_xlat16_1.xzw * u_xlat16_3.xyz;
    SV_TARGET0.w = 1.0;
    return;
}
...
uniform 	mediump vec4 _cRimt;
uniform 	mediump vec4 _cRimb;
UNITY_LOCATION(0) uniform mediump sampler2D _SDFTex;
...
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _SDFTex_ST.xy + _SDFTex_ST.zw;
    u_xlat16_0 = texture(_SDFTex, u_xlat0.xy);
    u_xlat0.x = dot(u_xlat16_0, _SDFChannels);
    u_xlat16_1.x = (-_OutlineDistance) + _ClippingValue;
    u_xlat16_1.x = u_xlat0.x + u_xlat16_1.x;
    u_xlat16_7 = u_xlat0.x + _ClippingValue;
    u_xlat16_1.y = log2(u_xlat16_7);
    ...
    u_xlat0.x = _cKey.w + _cKey.w;
    u_xlat6.x = _cRimt.w + _cRimt.w;
    u_xlat16_2 = texture(_Ramp2D, vs_TEXCOORD2.xy);
    u_xlat16_3.xyz = u_xlat16_2.xxx * _cRimt.xyz;
    u_xlat6.xyz = u_xlat6.xxx * u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat16_2.zzz * _cKey.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat0.xxx + u_xlat6.xyz;
    u_xlat16_4.xyz = (-_cAmbn.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = u_xlat16_2.yyy * u_xlat16_4.xyz + _cAmbn.xyz;
    u_xlat16_5.xyz = u_xlat16_2.www * _cRimb.xyz;
    u_xlat0.x = _cRimb.w + _cRimb.w;
    u_xlat16_4.xyz = u_xlat16_5.xyz * u_xlat0.xxx + u_xlat16_4.xyz;
#ifdef UNITY_ADRENO_ES3
