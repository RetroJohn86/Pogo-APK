...
void main ()
{
  ...
  roughness_39 = (1.0 - tmpvar_10);
  mediump vec4 tmpvar_40;
  tmpvar_40.xyz = worldNormal_38;
  tmpvar_40.w = ((roughness_39 * (1.7 - 
    (0.7 * roughness_39)
  )) * 6.0);
  lowp vec4 tmpvar_41;
  ...
  tmpvar_44 = clamp (((tmpvar_42.w * unity_SpecCube0_HDR.x) * tmpvar_42.xyz), 0.0, 1.0);
  tmpvar_43 = tmpvar_44;
  mediump vec3 tmpvar_45;
  tmpvar_45 = (tmpvar_9.xyz * tmpvar_36.xyz);
  color_29 = tmpvar_45;
  lowp vec4 tmpvar_46;
  tmpvar_46.w = 1.0;
  tmpvar_46.xyz = _LightColor0.xyz;
  mediump float tmpvar_47;
  tmpvar_47 = max (0.0, dot (tmpvar_23, normalize(
    (viewDir_26 + lightDir_25)
  )));
  nh_27 = tmpvar_47;
  mediump float tmpvar_48;
  tmpvar_48 = pow (nh_27, (tmpvar_10 * 128.0));
  specular_28 = (tmpvar_46 * tmpvar_48);
  specular_28.xyz = (specular_28.xyz + tmpvar_43);
  specular_28.xyz = (specular_28.xyz * vec3(_Specularity));
  color_29 = (color_29 + specular_28.xyz);
  lowp vec4 tmpvar_49;
  tmpvar_49.xyz = color_29;
  ...
  tmpvar_51 = mix (xlv_TEXCOORD4.xyz, c_1.xyz, xlv_TEXCOORD4.www);
