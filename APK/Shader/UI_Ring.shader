...
void main()
{
    ...
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat16_1 = u_xlat0 * u_xlat2;
    u_xlat16_3 = vs_COLOR0.w * u_xlat16_1 + -0.00100000005;
...
void main()
{
    ...
    u_xlat16_3 = dFdy(u_xlat0.x);
    u_xlat16_1 = abs(u_xlat16_3) + abs(u_xlat16_1);
    u_xlat2 = u_xlat0.x + (-_Radius);
    u_xlat2 = u_xlat2 / u_xlat16_1;
    u_xlat2 = clamp(u_xlat2, 0.0, 1.0);
    u_xlat2 = (-u_xlat2) + 1.0;
    u_xlat4 = (-_Thickness) + _Radius;
