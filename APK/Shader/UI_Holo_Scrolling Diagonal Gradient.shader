...
//
///////////////////////////////////////////
Shader "UI/Holo/Scrolling Diagonal Gradient" {
Properties {
...
uniform 	mediump vec4 _Gray;
uniform 	mediump float _GrayLerp;
...
void main()
{
    ...
    u_xlat3 = _Time.y * _Speed;
    u_xlat0.x = u_xlat0.x * _RampScale + u_xlat3;
    u_xlat10_0 = texture2D(_Ramp, u_xlat0.xx);
    u_xlat1 = (-u_xlat10_0) + _Gray;
    u_xlat0 = vec4(_GrayLerp) * u_xlat1 + u_xlat10_0;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1 = u_xlat10_1 + _TextureSampleAdd;
    u_xlat1 = u_xlat1 * vs_COLOR0;
    u_xlat10_2 = texture2D(_Mask, vs_TEXCOORD0.xy).w;
...
void main()
{
    ...
    u_xlat3 = _Time.y * _Speed;
    u_xlat0.x = u_xlat0.x * _RampScale + u_xlat3;
    u_xlat16_0 = texture(_Ramp, u_xlat0.xx);
    u_xlat1 = (-u_xlat16_0) + _Gray;
    u_xlat0 = vec4(_GrayLerp) * u_xlat1 + u_xlat16_0;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1 = u_xlat16_1 + _TextureSampleAdd;
    u_xlat1 = u_xlat1 * vs_COLOR0;
    u_xlat16_2 = texture(_Mask, vs_TEXCOORD0.xy).w;
...
{
    u_xlat0.x = vs_TEXCOORD0.y + (-vs_TEXCOORD0.x);
    u_xlat4 = _Time.y * _Speed;
    u_xlat0.x = u_xlat0.x * _RampScale + u_xlat4;
    u_xlat10_0 = texture2D(_Ramp, u_xlat0.xx);
    u_xlat1 = (-u_xlat10_0) + _Gray;
    u_xlat0 = vec4(_GrayLerp) * u_xlat1 + u_xlat10_0;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    ...
    u_xlat16_3 = u_xlat1.w * u_xlat0.w + -0.00100000005;
