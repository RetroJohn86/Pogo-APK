...
//
///////////////////////////////////////////
Shader "Niantic/SDF/ParticleAlphaBlend" {
Properties {
...
uniform 	mediump float _SDFFalloff;
...
void main()
{
    ...
    vs_COLOR0 = in_COLOR0;
    vs_TEXCOORD0.z = exp2(_SDFFalloff);
...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_0.w + _Clip;
    SV_Target0.xyz = u_xlat10_0.xyz * vs_COLOR0.xyz;
    u_xlat0.x = log2(u_xlat16_1);
