...
void main ()
{
  ...
  roughness_57 = (1.0 - tmpvar_10);
  mediump vec4 tmpvar_58;
  tmpvar_58.xyz = worldNormal_56;
  tmpvar_58.w = ((roughness_57 * (1.7 - 
    (0.7 * roughness_57)
  )) * 6.0);
  lowp vec4 tmpvar_59;
  ...
  tmpvar_62 = clamp (((tmpvar_60.w * unity_SpecCube0_HDR.x) * tmpvar_60.xyz), 0.0, 1.0);
  tmpvar_61 = tmpvar_62;
  lowp float tmpvar_63;
  tmpvar_63 = (1.0 - clamp (vdn_47, 0.0, 1.0));
  lowp vec3 tmpvar_64;
  tmpvar_64 = vec3((tmpvar_11 * (1.0 - clamp (
    ((tmpvar_63 * 50.0) - 8.0)
  , 0.0, 1.0))));
  tmpvar_38.xyz = mix (tmpvar_8.xyz, _PupilColor.xyz, tmpvar_64);
  mediump vec3 tmpvar_65;
  tmpvar_65 = (tmpvar_38.xyz * tmpvar_54.xyz);
  color_44 = tmpvar_65;
  lowp vec4 tmpvar_66;
  tmpvar_66.w = 1.0;
  tmpvar_66.xyz = xlat_mutable_LightColor0.xyz;
  mediump float tmpvar_67;
  tmpvar_67 = max (0.0, dot (tmpvar_39, normalize(
    (viewDir_41 + lightDir_40)
  )));
  nh_42 = tmpvar_67;
  mediump float tmpvar_68;
  tmpvar_68 = pow (nh_42, (tmpvar_10 * 128.0));
  specular_43 = (tmpvar_66 * tmpvar_68);
  specular_43.xyz = (specular_43.xyz + ((
    ((tmpvar_61 * (tmpvar_9.w * tmpvar_14.w)) * (1.0 - tmpvar_12.w))
   * tmpvar_63) * tmpvar_63));
  specular_43.xyz = (specular_43.xyz * tmpvar_9.xyz);
  color_44 = (color_44 + specular_43.xyz);
  lowp vec4 tmpvar_69;
  tmpvar_69.xyz = color_44;
  tmpvar_69.w = tmpvar_11;
  tmpvar_37 = tmpvar_69;
  c_1 = tmpvar_37;
  lowp vec4 color_70;
  color_70.w = c_1.w;
  mediump vec4 envFogColor_71;
  highp vec4 tmpvar_72;
  lowp vec4 tmpvar_73;
  tmpvar_73.w = 1.0;
  tmpvar_73.xyz = unity_FogColor.xyz;
  tmpvar_72 = tmpvar_73;
  envFogColor_71 = tmpvar_72;
  envFogColor_71.w = (envFogColor_71.w * xlv_TEXCOORD4.w);
  mediump vec3 tmpvar_74;
  tmpvar_74 = mix (envFogColor_71.xyz, c_1.xyz, envFogColor_71.www);
  color_70.xyz = tmpvar_74;
  c_1.xyz = color_70.xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
