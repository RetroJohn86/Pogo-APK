...
void main ()
{
  ...
  tmpvar_4 = clamp (((xlv_TEXCOORD1.w * 50.0) - 8.0), 0.0, 1.0);
  col_2.xyz = mix (tmpvar_3.xyz, _PupilColor.xyz, vec3((tmpvar_3.w * (1.0 - tmpvar_4))));
  lowp float tmpvar_5;
  tmpvar_5 = col_2.w;
  mediump vec4 tmpvar_6;
  mediump float ldn_7;
  ldn_7 = xlv_TEXCOORD1.x;
  mediump float fresnel_8;
  fresnel_8 = xlv_TEXCOORD1.w;
  lowp vec4 color_9;
  color_9 = xlv_TEXCOORD2;
  lowp vec4 rimColor_10;
  rimColor_10 = xlv_COLOR0;
  mediump float alpha_11;
  alpha_11 = tmpvar_5;
  lowp vec4 ramp_12;
  mediump vec2 tmpvar_13;
  tmpvar_13.x = ldn_7;
  tmpvar_13.y = fresnel_8;
  lowp vec4 tmpvar_14;
  tmpvar_14 = texture2D (_Ramp, tmpvar_13);
  ramp_12.w = tmpvar_14.w;
  mediump vec3 tmpvar_15;
  tmpvar_15 = mix (tmpvar_14.xyz, vec3(ldn_7), vec3(alpha_11));
  ramp_12.xyz = tmpvar_15;
  lowp vec4 tmpvar_16;
  tmpvar_16.w = 0.0;
  tmpvar_16.xyz = ramp_12.www;
  lowp vec4 tmpvar_17;
  tmpvar_17.xyz = ((ramp_12.xyz * _LightColor0.xyz) + ((rimColor_10 * tmpvar_16) + color_9).xyz);
  tmpvar_17.w = color_9.w;
  tmpvar_6 = tmpvar_17;
  diffuse_1 = tmpvar_6;
  col_2.xyz = (col_2.xyz * diffuse_1.xyz);
  gl_FragData[0] = col_2;
}
