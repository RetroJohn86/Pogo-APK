...
[Toggle(BRB_SCREENSPACE_ASPECTX)] _ScreenSpaceAspect ("    Screenspace aspect correction (fit horizontal)", Float) = 0
...
[Toggle(_VERTEXMODE_DIFFUSE)] _VertexMode ("Vertex RGBA multiply", Float) = 0
