...
void main()
{
    ...
    u_xlat16_1 = u_xlat10_0.x * u_xlat16_1 + _MaskOffValue;
    u_xlat16_2.y = 0.5;
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_5 = dot(u_xlat10_0.xyz, vec3(0.219999999, 0.707000017, 0.0710000023));
    u_xlat16_2.x = u_xlat16_5 + _RampOffset;
    u_xlat10_3.xyz = texture2D(_RampTex, u_xlat16_2.xy).xyz;
    u_xlat3.xyz = (-u_xlat10_0.xyz) + u_xlat10_3.xyz;
    u_xlat10_0.xyz = vec3(u_xlat16_1) * u_xlat3.xyz + u_xlat10_0.xyz;
...
void main()
{
    ...
    u_xlat16_1 = (-_MaskOffValue) + _MaskOnValue;
    u_xlat16_1 = u_xlat16_0.x * u_xlat16_1 + _MaskOffValue;
    u_xlat16_2.y = 0.5;
    u_xlat16_0 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_5 = dot(u_xlat16_0.xyz, vec3(0.219999999, 0.707000017, 0.0710000023));
    u_xlat16_2.x = u_xlat16_5 + _RampOffset;
    u_xlat16_3.xyz = texture(_RampTex, u_xlat16_2.xy).xyz;
    u_xlat3.xyz = (-u_xlat16_0.xyz) + u_xlat16_3.xyz;
    u_xlat16_0.xyz = vec3(u_xlat16_1) * u_xlat3.xyz + u_xlat16_0.xyz;
