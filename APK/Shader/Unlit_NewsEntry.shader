...
;
    ...
    u_xlat10_3.xyz = texture2D(_MaskTex, vs_TEXCOORD2.xy).xyz;
...
;
    ...
    u_xlat16_3.xyz = texture(_MaskTex, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2 = u_xlat16_3.x * u_xlat16_1.w;
    SV_Target0.w = u_xlat16_2 * u_xlat0.x + u_xlat16_3.y;
    u_xlat0.x = (-u_xlat16_3.y) * _ShadowStrength + 1.0;
    u_xlat16_2 = (-u_xlat16_3.z) + 1.0;
...
;
    ...
    u_xlat16_3.xyz = texture(_MaskTex, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2 = u_xlat16_3.x * u_xlat16_1.w;
    u_xlat16_2 = u_xlat16_2 * u_xlat0.x + u_xlat16_3.y;
    u_xlat16_5 = u_xlat16_2 + -0.00100000005;
    SV_Target0.w = u_xlat16_2;
