...
void main ()
{
  ...
  tmpvar_4 = clamp (xlv_TEXCOORD4, 0.0, 1.0);
...
void main ()
{
  lowp vec4 c_1;
  lowp vec4 c_2;
  c_2.xyz = texture2D (_MainTex, xlv_TEXCOORD0).xyz;
  c_2.w = 0.0;
  c_1.xyz = c_2.xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_2 = clamp (xlv_TEXCOORD4, 0.0, 1.0);
  c_1.xyz = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * vec3(tmpvar_2));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
