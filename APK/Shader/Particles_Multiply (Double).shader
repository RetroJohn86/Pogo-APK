...
void main ()
{
  ...
  col_2.xyz = ((tmpvar_4.xyz * xlv_COLOR.xyz) * 2.0);
  col_2.w = (tmpvar_1.w * tmpvar_4.w);
  lowp vec4 tmpvar_5;
  tmpvar_5 = mix (vec4(0.5, 0.5, 0.5, 0.5), col_2, col_2.wwww);
  col_2 = tmpvar_5;
...
void main ()
{
  ...
  col_2.xyz = mix (vec3(0.5, 0.5, 0.5), tmpvar_5.xyz, vec3(tmpvar_6));
  gl_FragData[0] = col_2;
}
