...
//
///////////////////////////////////////////
Shader "Niantic/World Map/Road Outline (Unlit)" {
Properties {
 _ColorRamp ("Ramp", 2D) = "white" { }
 _Emmission ("Emission", 2D) = "white" { }
...
void main ()
{
  ...
  tmpvar_8 = clamp (((xlv_TEXCOORD2.z - _NearDist) / (_FarDist - _NearDist)), 0.0, 1.0);
  tmpvar_7 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9 = texture2D (_ColorRamp, vec2(tmpvar_7));
  ...
  c_11.w = 0.0;
  c_10.w = c_11.w;
  c_10.xyz = (c_11.xyz + (tmpvar_9.xyz * xlv_TEXCOORD3));
  c_3.xyz = (c_10.xyz + texture2D (_Emmission, vec2(tmpvar_7)).xyz);
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  tmpvar_9 = clamp (((xlv_TEXCOORD2.z - _NearDist) / (_FarDist - _NearDist)), 0.0, 1.0);
  tmpvar_8 = tmpvar_9;
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_ColorRamp, vec2(tmpvar_8));
  ...
  c_17.w = 0.0;
  c_16.w = c_17.w;
  c_16.xyz = (c_17.xyz + (tmpvar_10.xyz * xlv_TEXCOORD3));
  c_4.xyz = (c_16.xyz + texture2D (_Emmission, vec2(tmpvar_8)).xyz);
  c_4.w = 1.0;
  gl_FragData[0] = c_4;
}
...
void main ()
{
  ...
  diff_15 = tmpvar_16;
  c_14.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_7)).xyz * tmpvar_1) * diff_15);
  c_14.w = 0.0;
  c_13.w = c_14.w;
  c_13.xyz = c_14.xyz;
  c_3.xyz = c_13.xyz;
...
void main ()
{
  ...
  diff_11 = tmpvar_12;
  c_10.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_7)).xyz * tmpvar_1) * diff_11);
  c_10.w = 0.0;
  c_9.w = c_10.w;
  c_9.xyz = c_10.xyz;
  c_3.xyz = c_9.xyz;
...
void main ()
{
  ...
  diff_19 = tmpvar_20;
  c_18.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_8)).xyz * tmpvar_1) * diff_19);
  c_18.w = 0.0;
  c_17.w = c_18.w;
  c_17.xyz = c_18.xyz;
  c_3.xyz = c_17.xyz;
...
void main ()
{
  ...
  diff_14 = tmpvar_15;
  c_13.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_7)).xyz * tmpvar_1) * diff_14);
  c_13.w = 0.0;
  c_12.w = c_13.w;
  c_12.xyz = c_13.xyz;
  c_3.xyz = c_12.xyz;
...
void main ()
{
  ...
  diff_10 = tmpvar_11;
  c_9.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_7)).xyz * tmpvar_1) * diff_10);
  c_9.w = 0.0;
...
void main ()
{
  ...
  diff_18 = tmpvar_19;
  c_17.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_8)).xyz * tmpvar_1) * diff_18);
  c_17.w = 0.0;
  highp float tmpvar_20;
...
void main ()
{
  ...
  diff_13 = tmpvar_14;
  c_12.xyz = ((texture2D (_ColorRamp, vec2(tmpvar_7)).xyz * tmpvar_1) * diff_13);
  c_12.w = 0.0;
...
void main ()
{
  ...
  tmpvar_5 = clamp (((xlv_TEXCOORD1.z - _NearDist) / (_FarDist - _NearDist)), 0.0, 1.0);
  tmpvar_4 = tmpvar_5;
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture2D (_Emmission, vec2(tmpvar_4));
  lowp vec4 tmpvar_7;
  ...
  lowp vec4 c_8;
  c_8.xyz = (texture2D (_ColorRamp, vec2(tmpvar_4)).xyz * light_3.xyz);
  c_8.w = 0.0;
  c_2 = c_8;
  c_2.xyz = (c_2.xyz + tmpvar_6.xyz);
  c_2.w = 1.0;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  lowp vec4 c_9;
  c_9.xyz = (texture2D (_ColorRamp, vec2(tmpvar_4)).xyz * light_3.xyz);
  c_9.w = 0.0;
  c_2 = c_9;
  c_2.xyz = (c_2.xyz + tmpvar_6.xyz);
  c_2.w = 1.0;
