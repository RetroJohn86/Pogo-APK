...
Properties {
 _AlphaToColor ("Vertex Color A to RGB", Range(0.000000,1.000000)) = 0.000000
 _ColorToColor ("Vertex Color RGB to RGB", Range(0.000000,1.000000)) = 0.000000
[Toggle(BRB_INVERT)]  _Invert ("Invert Vertex Color R (if baked from OS normal)", Float) = 1.000000
}
SubShader { 
 LOD 100
