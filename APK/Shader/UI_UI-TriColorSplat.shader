...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat0.yyy * _ColorG.xyz;
    u_xlat16_1.xyz = u_xlat0.xxx * _ColorR.xyz + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat0.zzz * _ColorB.xyz + u_xlat16_1.xyz;
...
void main()
{
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 + _TextureSampleAdd;
    u_xlat16_1.x = u_xlat0.w + -0.00100000005;
...
;
    ...
    u_xlat16_2.xyz = u_xlat1.yyy * _ColorG.xyz;
    u_xlat16_2.xyz = u_xlat1.xxx * _ColorR.xyz + u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat1.zzz * _ColorB.xyz + u_xlat16_2.xyz;
    return;
}
