...
//
///////////////////////////////////////////
Shader "Niantic/Fx/Additive-Tinted-GpuInstanced" {
Properties {
...
void main()
{
    ...
    u_xlat0 = u_xlat10_0 * vs_COLOR0.wxyz;
...
void main()
{
    u_xlat16_0 = texture(_MainTex, vs_TEXCOORD0.xy).wxyz;
    u_xlat0 = u_xlat16_0 * vs_COLOR0.wxyz;
    SV_Target0.xyz = u_xlat0.xxx * u_xlat0.yzw;
    SV_Target0.w = u_xlat0.x;
    return;
}
