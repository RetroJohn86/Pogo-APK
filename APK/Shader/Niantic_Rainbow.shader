...
void main()
{
    ...
    u_xlat0 = u_xlat16_4.xxxx + vec4(-0.600000024, -0.449999988, -0.174999997, -0.159999996);
    u_xlat0 = u_xlat0 * (-u_xlat0);
    u_xlat0 = u_xlat0 * vec4(52.4616356, 32.0598869, 240.449173, 360.673737);
    u_xlat0 = exp2(u_xlat0);
    u_xlat0 = u_xlat0 * vec4(1.0, 1.0, 0.800000012, 0.200000003);
