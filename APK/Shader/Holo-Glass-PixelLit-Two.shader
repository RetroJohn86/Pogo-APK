...
void main ()
{
  ...
  roughness_41 = (1.0 - tmpvar_11);
  mediump vec4 tmpvar_42;
  tmpvar_42.xyz = worldNormal_40;
  tmpvar_42.w = ((roughness_41 * (1.7 - 
    (0.7 * roughness_41)
  )) * 6.0);
  lowp vec4 tmpvar_43;
  ...
  tmpvar_46 = clamp (((tmpvar_44.w * unity_SpecCube0_HDR.x) * tmpvar_44.xyz), 0.0, 1.0);
  tmpvar_45 = tmpvar_46;
  mediump vec3 tmpvar_47;
  tmpvar_47 = (tmpvar_10.xyz * tmpvar_38.xyz);
  color_30 = tmpvar_47;
  lowp vec4 tmpvar_48;
  tmpvar_48.w = 1.0;
  tmpvar_48.xyz = _LightColor0.xyz;
  mediump float tmpvar_49;
  tmpvar_49 = max (0.0, dot (tmpvar_24, normalize(
    (viewDir_27 + lightDir_26)
  )));
  nh_28 = tmpvar_49;
  mediump float tmpvar_50;
  tmpvar_50 = pow (nh_28, (tmpvar_11 * 128.0));
  specular_29 = (tmpvar_48 * tmpvar_50);
  specular_29.xyz = (specular_29.xyz + tmpvar_45);
  specular_29.xyz = (specular_29.xyz * vec3(_Specularity));
  color_30 = (color_30 + specular_29.xyz);
  lowp vec4 tmpvar_51;
  tmpvar_51.xyz = color_30;
  tmpvar_51.w = tmpvar_12;
  tmpvar_23 = tmpvar_51;
  c_1 = (c_1 + tmpvar_23);
  lowp vec4 color_52;
  color_52.w = c_1.w;
  highp vec3 tmpvar_53;
  tmpvar_53 = mix ((xlv_TEXCOORD4.xyz * c_1.w), c_1.xyz, xlv_TEXCOORD4.www);
  color_52.xyz = tmpvar_53;
  c_1 = color_52;
  gl_FragData[0] = color_52;
}
