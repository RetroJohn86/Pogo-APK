...
[KeywordEnum(None, Unlit, SpecularColor, DesaturatedRamp, LinearRamp)] _BaseAlpha ("    Alpha Mode", Float) = 0
...
void main ()
{
  ...
  tmpvar_32 = normalize((tmpvar_5 * tmpvar_31));
  ...
  xlv_TEXCOORD6 = (tmpvar_29 * abs(rim_8));
}
