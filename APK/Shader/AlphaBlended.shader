...
Properties {
 ...
 _Offset ("Z Offset", Float) = 0.000000
[RenderQueue]  _RenderQueuePlaceholder ("Render Queue", Float) = 0.000000
[Enum(UnityEngine.Rendering.CompareFunction)]  _ZComp ("Z Compare Function", Float) = 0.000000
