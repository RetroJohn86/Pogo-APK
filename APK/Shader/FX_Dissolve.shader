...
void main()
{
    u_xlat10_0.x = texture2D(_DisolveTex, vs_TEXCOORD1.xy).x;
    u_xlat0 = dot(u_xlat10_0.xx, vs_COLOR0.ww);
...
#define UNITY_BINDING(x) layout(std140)
#endif
UNITY_LOCATION(0) uniform mediump sampler2D _DisolveTex;
...
void main()
{
    u_xlat16_0.x = texture(_DisolveTex, vs_TEXCOORD1.xy).x;
    u_xlat0 = dot(u_xlat16_0.xx, vs_COLOR0.ww);
    u_xlat0 = u_xlat0 + vs_COLOR0.w;
    u_xlat16_1 = u_xlat0 * u_xlat0;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_1;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_1;
