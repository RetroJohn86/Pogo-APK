...
#endif
precision highp int;
uniform 	mediump float _SilhouetteStrength;
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(_SilhouetteStrength) * u_xlat16_1.xyz + u_xlat0.xyz;
    u_xlat16_7 = u_xlat0.w * vs_COLOR0.w;
...
void main()
{
    ...
    u_xlat16_1.xyz = (-u_xlat0.xyz) + vs_COLOR0.xyz;
    u_xlat16_1.xyz = vec3(_SilhouetteStrength) * u_xlat16_1.xyz + u_xlat0.xyz;
    u_xlat16_10 = u_xlat0.w * vs_COLOR0.w;
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 + _TextureSampleAdd;
    u_xlat16_3.x = u_xlat0.w * vs_COLOR0.w;
    u_xlat16_5 = u_xlat16_3.x * u_xlat16_1 + -0.00100000005;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_3.x;
    u_xlatb6 = u_xlat16_5<0.0;
    if(u_xlatb6){discard;}
    u_xlat16_3.xyz = (-u_xlat0.xyz) + vs_COLOR0.xyz;
    u_xlat16_3.xyz = vec3(_SilhouetteStrength) * u_xlat16_3.xyz + u_xlat0.xyz;
