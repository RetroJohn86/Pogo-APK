...
//
///////////////////////////////////////////
Shader "Niantic/UI/Unlit/Simple-Panner-Transparent" {
Properties {
...
uniform 	vec4 _PanningDirection;
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xy * _UVOffset.xy + _UVOffset.zw;
    u_xlat4 = _Time.y * _PanningSpeed;
    vs_TEXCOORD0.xy = vec2(u_xlat4) * _PanningDirection.xy + u_xlat0.xy;
