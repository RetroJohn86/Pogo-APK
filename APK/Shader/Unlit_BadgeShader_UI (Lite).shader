...
;
    ...
    u_xlat10_3 = texture2D(_MaskTex, vs_TEXCOORD2.xy).x;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat10_3 * u_xlat10_1.w;
    u_xlat10_1.w = u_xlat0.x * u_xlat16_2;
...
;
    u_xlat0.xy = u_xlat0.zw * u_xlat0.xy;
    u_xlat0.x = u_xlat0.y * u_xlat0.x;
    u_xlat16_3 = texture(_MaskTex, vs_TEXCOORD2.xy).x;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat16_3 * u_xlat16_1.w;
    u_xlat16_1.w = u_xlat0.x * u_xlat16_2;
