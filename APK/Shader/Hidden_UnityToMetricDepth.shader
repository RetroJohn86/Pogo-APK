...
void main()
{
    ...
    gl_Position = u_xlat0 * vec4(1.0, -1.0, 1.0, 1.0);
    return;
}
...
#endif
precision highp int;
uniform 	float _ZBufferParams_Z;
uniform 	float _ZBufferParams_W;
...
void main()
{
    ...
    u_xlat0 = _ZBufferParams_Z * u_xlat0 + _ZBufferParams_W;
    SV_Target0 = float(1.0) / u_xlat0;
    return;
}
